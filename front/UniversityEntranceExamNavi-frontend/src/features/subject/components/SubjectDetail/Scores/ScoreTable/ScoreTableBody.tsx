...
import type { SubjectScores, SubjectScoreDetail, ScoreMetrics } from '@/lib/types/score';
...
const ScoreCell: FC<{ data: ScoreMetrics; label: string }> = memo(({ data, label }) => (
...
const ScoreTableBody: FC<ScoreTableBodyProps> = memo(({ calculatedScores, sortedSubjects }) => {
